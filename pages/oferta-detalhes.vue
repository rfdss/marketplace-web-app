        ...
        <div class="section">
          ...
          <div class="columns">
            <div class="column is-5">
              <div class="box">
                <figure class="image is-square" v-if="offer">
                  <img :src="offer.image64" :alt="offer.title" v-if="offer && offer.image64">
            ...
            <div class="column is-7">
              <div class="box">
                <div class="is-flex flex-dir-col justify-between">
                    ...
                    <!-- <div class="box-divider mb-1rem" v-if="offer.promotionQuantity >= 0">
    ...
    <section class="hero hero-top-offers" ref="sectionTopOffers">
      <div class="hero-body">
        <div class="section">
          ...
          <swiper class="topOffersSwiper" :options="swiperOption" v-if="topOffers && topOffers.length > 0">
...
export default {
  ...
  created() {
    const { params: { offer } } = this.$route
    
    if (!offer) this.$router.go(-1)
